/**
 * About Section Content (TwoColumnGrid)
 */

import type { TwoColumnContent } from '../../config/types';
...
export const aboutContent: TwoColumnContent = {
  ...
  image: '/images/grid-image-1.svg',
  imageAlt: 'Strategic partnership visualization',
